...
import famille1 from "@/public/images/prestations/famille/famille1.png";
...
{/* -------------------------------------------Card------------------------------------------------------ */}
        ...
        >
          <div className="relative flex items-center justify-center hover:scale-95 transition duration-500">
            <Image src={famille1} alt="image" className=" object-cover"/>
          </div>
...
{/* -------------------------------------------Card------------------------------------------------------ */}
        ...
        >
          ...
          <div className="flex flex-col absolute p-10 gap-2">
            <span className="mt-1 sm:text-2xl lg:text-4xl text-base font-bold font-sans text-white">Shooting 1/2 journée</span>
            <p className="lg:text-xl text-sm">
              Le shooting comprend une prise de vue d'une demi-journée<br />
              avec toutes les photos téléchargeables sur votre galerie privée.
            </p>
            <span className="lg:text-xl text-sm font-bold font-sans">
              Prix : 490€
            </span>
